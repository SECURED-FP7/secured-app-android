LOCAL_PATH := $(call my-dir) #localizza i file sorgenti nella current directory
include $(CLEAR_VARS) #pulisce molte variabili LOCAL
...
strongswan_CHARON_PLUGINS := android-log openssl fips-prf random nonce pubkey \
	...
	eap-identity eap-mschapv2 eap-md5 eap-gtc oat-attest soup
