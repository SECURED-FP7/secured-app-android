...
_g_io_modules_ensure_loaded (void)
{
  ...
  //ora g_io_extension_point_lookup (G_TLS_BACKEND_EXTENSION_POINT_NAME) restituisce l'extension point, e non null
  G_LOCK (loaded_dirs);
  ...
  if (!loaded_dirs)
    {
      ...
      module_path="/data/data/org.strongswan.android/lib";
